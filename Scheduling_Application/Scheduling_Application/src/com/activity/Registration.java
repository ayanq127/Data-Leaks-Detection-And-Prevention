				...
				try
				  {
					Connection con;
					con = Dbconn.conn();
					String sql="insert into ownerregistration(Uname,Uaddress,Umobno,Uemail,Upassword) values(?,?,?,?,?)";
				...
				try
				  {
					...
					String sql="insert into userregistration(Uname,Uaddress,Umobno,Uemail,Upassword) values(?,?,?,?,?)";
					PreparedStatement p=(PreparedStatement) con.prepareStatement(sql);
