...
//                System.out.println("ByteSubs in=>\t"+temp+"\n");
    ...
    private static byte[][] ShiftRows(byte[][] state) {
        ...
        for (int r = 1; r < 4; r++) {
            ...
            for (int c = 0; c < Nb; c++) {
                state[r][c] = t[c];
//                System.out.println("ShiftRow in=>\t"+ state[r][c]+"\n");
            }
        }
    ...
    private static byte[][] InvShiftRows(byte[][] state) {
        ...
        for (int r = 1; r < 4; r++) {
            ...
            for (int c = 0; c < Nb; c++) {
                state[r][c] = t[c];
//                System.out.println("InvShiftRow in=>\t"+state[r][c]+"\n");
            }
        }
        return state;
    }
    ...
    private static byte[][] InvMixColumns(byte[][] s) {
        ...
        for (int c = 0; c < 4; c++) {
           ...
           // System.out.println(sp[0]+"\t"+sp[1]+"\t"+sp[2]+"\t"+sp[3]);
            for (int i = 0; i < 4; i++) {
                s[i][c] = (byte) (sp[i]);
    ...
    private static byte[][] MixColumns(byte[][] s) {
        ...
        for (int c = 0; c < 4; c++) {
           ...
           // System.out.println(sp[0]+"\t"+sp[1]+"\t"+sp[2]+"\t"+sp[3]);
            for (int i = 0; i < 4; i++) {
                s[i][c] = (byte) (sp[i]);
//                System.out.println("MixColumn in=>\t"+s[i][c]+"\n");
            }
        }
        return s;
    }
...
//        System.out.println("Generate Subkeys=>"+w);
        int count = 0;
