...
<body class="homepage">
	...
	<td class="col-md-2"><h3>Download</h3></td>
			<td class="col-md-2"><h3>Delete</h3> </td>
				...
				String qrry1 = "select * from fileinfo where user='"+username+"'";
              ...
              <a href="Ofiledownload?filenamedb=<%=rs1.getString("filename")%>"><input type="button" name="Download" value="Download" class="btn btn-info"></a></td>
               <td> <a href="deletefile?filenamedb=<%=rs1.getString("filename")%>" ><input type="button" name="Delete" value="Delete" class="btn btn-danger" ></a></td>
