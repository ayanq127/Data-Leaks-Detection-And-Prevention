...
<body class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse ">
                    <ul class="nav navbar-nav">
                       ...
                       <li class="active"><a href="UFileDownload.jsp">File Request</a></li>
								<li><a href="UAccessFile.jsp">File Access</a></li>
	...
	<td class="col-md-2"><h3>Request Send</h3></td>
			<td class="col-md-2"><h3>Status</h3> </td>
				...
				String qrry1 = "select * from access where To_Name='"+username+"'";
              ...
              <a href="sendrequest?filenamedb=<%=rs1.getString("File_Name")%>,<%=rs1.getString("From_Name")%>,<%=rs1.getString("id")%>"><input type="button" name="Download" value="Send Request" class="btn btn-info"></a></td>
              <td> <%= rs1.getString("User_Status") %> </td>
