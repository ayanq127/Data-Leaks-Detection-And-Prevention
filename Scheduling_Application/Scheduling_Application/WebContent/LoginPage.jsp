           ...
           <div class="center wow fadeInDown">
			...
			<tr>
					...
					<td align=left style="font-size: 20px;"><input type="radio"
						...
						<input 	type="radio" required name="rdo1" value="TtpInfo" id="Owner" />TPA
						<input type="radio"
						name="rdo1" required value="OwnerInfo" id="User" />Owner
						<input type="radio"
						name="rdo1" required value="Investigator" id="User" />Investigator
						</td>
										</tr>
	       <tr>
