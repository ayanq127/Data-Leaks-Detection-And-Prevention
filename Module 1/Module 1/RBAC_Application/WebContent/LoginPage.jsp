						...
						<table class="table table-responsive table-bordered">
							<tr>
								...
								<td class="col-md-6"><input type="text"
									class="form-control" name="txt_Uname"
									pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required
									id="txt_Uname" placeholder="Enter Email-ID"></td>
							</tr>
							...
							<tr>
								<td class="col-md-6" colspan="2" align="center"><input
									...
									id="btn_Submit" Value="Login"><br> <a
									class="active" href="Registration.jsp">Create New User</a>|<a
									class="active" href="ForgetPassword.jsp">Forget Password</a></td>
							</tr>
						</table>
					</div>
				</form>
